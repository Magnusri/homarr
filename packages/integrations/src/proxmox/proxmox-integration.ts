  ...
  implements IClusterHealthMonitoringIntegration, IIndividualResourceMonitoringIntegration
{
  ...
  public async getNodeDetailsAsync(nodeName: string): Promise<NodeDetails> {
    ...
    return {
      ...
      loadAverage1: typeof nodeStatus.loadavg?.[0] === "number" ? nodeStatus.loadavg[0] : 0,
      loadAverage5: typeof nodeStatus.loadavg?.[1] === "number" ? nodeStatus.loadavg[1] : 0,
      loadAverage15: typeof nodeStatus.loadavg?.[2] === "number" ? nodeStatus.loadavg[2] : 0,
